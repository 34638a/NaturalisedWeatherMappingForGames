...
//PLEASE NOTE THIS CODE IS NOT MY OWN, IT IS PUBLICLY AVALIABLE AT THE FOLOWING LINK:
//http://pastebin.com/prR2zKqe/
public class SimplexNoiseMaker {
	...
	public SimplexNoiseMaker(int seed) {
		p = p_temp.clone();
